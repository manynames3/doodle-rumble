...
The v0.6.8 movie was regenerated after the transparent character-pack integration. Scenes with active fighters now use the new pose art; celebration scenes continue to use the game's existing expressive result rigs because the packs contain no victory frames. The new encode is 30.00 seconds, 1280×720 at 24 fps, with the original ending music. Native Godot Theora playback was captured at four points, including an early packed-art shot and the desk return. Regenerated movies should be checked this way as well as decoded with FFmpeg. The movie temporarily owns the music channel, and its modal controls contain keyboard focus until returning to results.
