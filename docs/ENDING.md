...
The v0.6.9 movie was regenerated after packed-art result animation was added. All nine characters keep their transparent character art through the celebration, with motion and stars drawn by the shared renderer. The encode is 30.00 seconds, 1280×720 at 24 fps, with the original ending music. Native Godot Theora playback was checked at 3, 11, 21 and 27 seconds, including the group finale and desk return. Regenerated movies should be checked this way as well as decoded with FFmpeg. The movie temporarily owns the music channel, and its modal controls contain keyboard focus until returning to results.
